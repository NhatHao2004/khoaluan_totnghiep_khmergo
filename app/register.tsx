...
const styles = StyleSheet.create({
  ...
  scrollContent: { paddingHorizontal: scale(20), paddingTop: verticalScale(10), paddingBottom: 0, backgroundColor: '#FFF' },
  backBtn: { width: scale(40), height: scale(40), borderRadius: scale(20), backgroundColor: '#FFF', justifyContent: 'center', alignItems: 'center', marginBottom: verticalScale(20) },
  ...
  loginLinkText: { fontSize: moderateScale(16), color: '#64748B', fontWeight: '600', marginBottom: verticalScale(4) },

  card: { backgroundColor: 'transparent', borderRadius: scale(32), padding: scale(24) },

  avatarWrapper: { alignItems: 'center', marginBottom: verticalScale(30) },
  avatarContainer: { width: scale(100), height: scale(100), padding: scale(4), borderRadius: scale(50), backgroundColor: '#FFF', borderWidth: 2, borderColor: '#F1F5F9', position: 'relative' },
  avatarInner: { flex: 1, borderRadius: scale(46), overflow: 'hidden' },
  avatarImg: { width: '100%', height: '100%', borderRadius: scale(46) },
  avatarPlaceholder: { flex: 1, justifyContent: 'center', alignItems: 'center' },
  addBtnSmall: { position: 'absolute', bottom: 0, right: 0, width: scale(28), height: scale(28), borderRadius: scale(14), backgroundColor: '#10B981', justifyContent: 'center', alignItems: 'center', borderWidth: 3, borderColor: '#FFF' },
  avatarHint: { marginTop: verticalScale(10), fontSize: moderateScale(13), color: '#94A3B8', fontWeight: '600' },

  form: { gap: verticalScale(18), marginBottom: verticalScale(12) },
  inputGroup: { gap: verticalScale(8) },
  inputLabel: { fontSize: moderateScale(14), fontWeight: '700', color: '#64748B', marginLeft: scale(4) },
  ...
  interestsBox: { marginBottom: verticalScale(20) },
  interestsHeader: { fontSize: moderateScale(14), fontWeight: '700', color: '#64748B', marginBottom: verticalScale(15), marginLeft: scale(4) },
  ...
  footerText: { fontSize: moderateScale(13), color: '#94A3B8' },

  modalOverlay: { flex: 1, backgroundColor: 'rgba(15, 23, 42, 0.6)', justifyContent: 'center', alignItems: 'center', padding: scale(20) },
  modalContent: { backgroundColor: '#FFF', width: '100%', borderRadius: scale(32), padding: scale(24) },
  modalHeader: { paddingBottom: verticalScale(15), borderBottomWidth: 1, borderBottomColor: '#F1F5F9' },
  modalTitle: { fontSize: moderateScale(18), fontWeight: '900', color: '#1E293B', textAlign: 'center' },
  modalScroll: { marginVertical: verticalScale(20), maxHeight: verticalScale(400) },
  termsText: { fontSize: moderateScale(14), lineHeight: verticalScale(22), color: '#475569', textAlign: 'justify' },
  termsBold: { fontWeight: '800', color: '#0F172A' },
  acceptBtn: { backgroundColor: '#1E293B', height: verticalScale(56), borderRadius: scale(16), justifyContent: 'center', alignItems: 'center' },
  acceptBtnText: { color: '#FFF', fontSize: moderateScale(15), fontWeight: '800', lineHeight: verticalScale(22), includeFontPadding: false },
